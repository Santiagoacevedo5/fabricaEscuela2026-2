...
export default function Tiendas() {
  ...
  const cargarTiendas = async () => {
    try {
      ...
      if (res.ok) {
        ...
        console.error('Error al cargar tiendas:', res.status);
      }
    } catch (e) {
  ...
  const validarFormulario = () => {
    ...
    if (!formData.nombre.trim()) {
      errs.nombre = 'Campo obligatorio';
    }

    if (!formData.direccion.trim()) {
      errs.direccion = 'Campo obligatorio';
    }

    if (!formData.region.trim()) {
      errs.region = 'Campo obligatorio';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Enviando tienda al backend:', tienda);
      ...
      if (res.ok) {
        const tiendaGuardada = await res.json();

        console.log('Tienda guardada correctamente:', tiendaGuardada);
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: `1px solid ${
                      errores.nombre ? '#ef4444' : '#d1d5db'
                    }`,
                    backgroundColor:
                      errores.nombre ? '#fef2f2' : '#fff',
                    fontSize: '14px',
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: `1px solid ${
                      errores.direccion ? '#ef4444' : '#d1d5db'
                    }`,
                    backgroundColor:
                      errores.direccion ? '#fef2f2' : '#fff',
                    fontSize: '14px',
                    boxSizing: 'border-box',
                    outline: 'none'
                  }}
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: `1px solid ${
                      errores.region ? '#ef4444' : '#d1d5db'
                    }`,
                    backgroundColor:
                      errores.region ? '#fef2f2' : '#fff',
                    fontSize: '14px',
                    boxSizing: 'border-box',
                    outline: 'none'
                  }}
